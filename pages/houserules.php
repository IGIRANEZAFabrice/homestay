...
<body>
  ...
  <section class="houserules-hero">
    ...
    <div class="hero-image">
      <img src="../img/homestay.jpg" alt="Virunga Homestay">
    </div>
  </section>

  <section class="houserules-info-grid">
    <div class="info-card"><i class="fas fa-clock"></i><span>Check-In: 12:00 PM</span></div>
    <div class="info-card"><i class="fas fa-sign-out-alt"></i><span>Check-Out: 12:00 PM</span></div>
    ...
    <div class="info-card"><i class="fas fa-ban"></i><span>No Smoking</span></div>
    <div class="info-card"><i class="fas fa-paw"></i><span>No Pets</span></div>
    <div class="info-card"><i class="fas fa-users-slash"></i><span>No Unapproved Guests</span></div>
    <div class="info-card"><i class="fas fa-exclamation-triangle"></i><span>Guest Liable for Damage</span></div>
    <div class="info-card"><i class="fas fa-parking"></i><span>Free Parking</span></div>
    <div class="info-card"><i class="fas fa-wifi"></i><span>Free Wifi</span></div>
    <div class="info-card"><i class="fas fa-tshirt"></i><span>Laundry Service</span></div>
    <div class="info-card"><i class="fas fa-lock"></i><span>Lock Room, Not Responsible for Loss</span></div>
  </section>
  ...
  <section class="houserules-main" id="houserulesMainSection">
    ...
    <div class="rules-list">
      ...
      <div class="rule-card">
        ...
        <p>Check with the host beforehand if you wish to bring a pet with you.</p>
      </div>
      <div class="rule-card">
        <h3><i class="fas fa-sign-in-alt"></i> Check-In & Check-Out</h3>
        <p>Arrive at the homestay at the agreed-upon check-in time, or inform the host ahead of time if you will be late. Leave the property on time at check-out. Extra cost of 50% of the current cost for the room applies when the check-out time is not respected as agreed upon.</p>
      </div>
      <div class="rule-card">
        <h3><i class="fas fa-bed"></i> Curfew</h3>
        <p>Curfew from 10:30 PM until 5:00 AM. Please remain within the premises during curfew hours to maintain a peaceful environment for all guests.</p>
      </div>
      <div class="rule-card">
        <h3><i class="fas fa-user-friends"></i> Guests & Visitors</h3>
        <p>Do not bring additional guests or visitors onto the property without the host's permission. Ensure that any visitors or guests you do bring follow the house rules.</p>
      </div>
      <div class="rule-card">
