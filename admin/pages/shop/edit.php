<?php
/**
 * Shop Items Management - Edit Item
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Handle image upload
    $image_path = $form_data['current_image']; // Keep current image by default
    ...
    if (empty($errors)) {
        try {
            $query = "UPDATE shop_items 
                      SET title = ?, description = ?, price = ?, image = ?, tag = ?, updated_at = NOW() 
                      WHERE id = ?";

            $result = updateData($query, 'ssdssi', [
                $form_data['title'],
            ...
            if ($result !== false) {
                ...
                if ($delete_old_image && !empty($form_data['current_image'])) {
                    $old_image_path = $_SERVER['DOCUMENT_ROOT'] . '/homestay/' . $form_data['current_image'];
                ...
                // Log activity
                logActivity('update_shop_item', "Updated shop item: {$form_data['title']}");
                
                // Redirect with success message
                redirectWithMessage('index.php', 'Shop item updated successfully!', 'success');
            } else {
                $errors['general'] = 'Failed to update shop item. Please try again.';
            }
        } catch (Exception $e) {
...
<head>
    ...
    <title>Edit Shop Item - Virunga Homestay Admin</title>
        ...
        <main class="admin-main">
            ...
            <div class="admin-content">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 class="h3 mb-0">Edit Shop Item</h1>
                                ...
                                <form method="POST" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php if (!empty($form_data['current_image'])): ?>
                                            <div class="mb-2">
                                                ...
                                                <img src="<?= htmlspecialchars(getImageDisplayPath($form_data['current_image'])) ?>" 
                                                     alt="Current item image" class="current-image">
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="form-text">
                                            ...
                                            Upload a new image to replace the current one. Supported formats: JPG, PNG, GIF. Max size: 5MB.
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save me-2"></i>Update Shop Item
                                        </button>
                                    </div>
                                </form>
                            </div>
