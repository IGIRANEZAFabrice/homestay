-- About Us Page Database Structure

-- Create about_sections table to store main section content
...
-- Create about_features table to store feature cards for "Why Choose" section
...
-- Create about_guidelines table to store guideline cards
...
-- Insert default data for about_sections
INSERT INTO `about_sections` (`section_name`, `title`, `subtitle`, `content`, `image_path`, `display_order`) VALUES
('hero', 'About Us', 'About Virunga Homestay', NULL, NULL, 1),
('mission', 'Our Mission', NULL, 'Virunga Homestay offers travellers an authentic cultural immersion beyond ordinary tourism. Guests engage in traditional ceremonies, learn age-old Rwandan recipes, and share meaningful conversations that deepen their understanding of Rwandan life and values.\n\nEach homestay is carefully selected to provide both modern comfort and a genuine glimpse into Rwanda\'s vibrant heritage, whether in peaceful villages or lively towns. We prioritise safety and warm hospitality to ensure guests feel completely at home.\n\nOur mission is to promote sustainable tourism by empowering local communities, training women and youth in hospitality and tourism skills, and creating livelihood opportunities that reduce rural-to-urban migration.', '../img/house.jpg', 2),
...
('guidelines', 'Be a Responsible Guest', 'Staying at Virunga Homestay means becoming part of a Rwandan home and community. Here\'s how to make the most of your authentic experience.', NULL, NULL, 4),
('experience', 'More Than Just Accommodation', 'By staying with us, travelers contribute directly to local economic growth while enjoying a transformative, memorable experience rooted in true Rwandan culture. You\'re not just a guest – you\'re part of the family, part of the community, and part of a sustainable future for Rwanda.', NULL, NULL, 5),
('cta', 'Ready for Your Authentic Experience?', 'Join us for an unforgettable journey into the heart of Rwandan culture and hospitality.', NULL, NULL, 6);

-- Insert default data for about_features
...
-- Insert default data for about_guidelines
